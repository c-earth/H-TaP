...
axA = axs[0,0]
axA.plot(ref_data['T_nh'], ref_data['n_h'],linestyle='--',marker='o',markersize=10,linewidth=3,label='$n_h$', color='#2F349A')
axA.plot(ref_data['T_ne'], ref_data['n_e'],linestyle='--',marker='o',markersize=10,linewidth=3,label='$n_e$', color='#E33119')
...
axA.yaxis.get_offset_text().set_size(26)
...
axB.plot(ref_data['T_ue'], ref_data['u_e'],linestyle='--',marker='s',markersize=10,linewidth=3,label='$\mu_e$', color='#E33119')
...
ax1 = axs[2,0] 
ax1.plot(s2_data['T(K)'], s2_data['nh(m^-3)']*cnst1,linestyle='--',marker='o',markersize=10,linewidth=3,label='$n_h$', color='#2F349A')
ax1.plot(s2_data['T(K)'], s2_data['ne(m^-3)']*cnst1,linestyle='--',marker='o',markersize=10,linewidth=3,label='$n_e$', color='#E33119')
...
ax2.plot(s2_data['T(K)'], s2_data['ue(m^2/Vs)']*cnst2,linestyle='--',marker='s',markersize=10,linewidth=3,label='$\mu_e$', color='#E33119')
...
ax3 = axs[1,0] 
ax3.plot(s4_data['T(K)'], s4_data['nh(m^-3)']*cnst1,linestyle='--',marker='o',markersize=10,linewidth=3,label='$n_h$', color='#2F349A')
ax3.plot(s4_data['T(K)'], s4_data['ne(m^-3)']*cnst1,linestyle='--',marker='o',markersize=10,linewidth=3,label='$n_e$', color='#E33119')
...
ax3.xaxis.get_offset_text().set_size(26)
ax3.yaxis.get_offset_text().set_size(26)
...
ax4.plot(s4_data['T(K)'], s4_data['ue(m^2/Vs)']*cnst2,linestyle='--',marker='s',markersize=10,linewidth=3,label='$\mu_e$', color='#E33119')
