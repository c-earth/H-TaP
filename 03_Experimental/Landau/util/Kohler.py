...
def plot_rho(Ts, Bs, rho_xxs, cutoff, resu_dir):
    ...
    ax.set_xlabel(r'$B$ [T]', fontsize = 20)
    ax.set_ylabel(r'$\rho_{xx}$ [$\Omega$cm]', fontsize = 20)
...
def plot_MR(Ts, Bs, MRs, cutoff, resu_dir):
    ...
    ax.set_xlabel(r'$B$ [T]', fontsize = 20)
    ax.set_ylabel(r'MR [%]', fontsize = 20)
    ax.tick_params(which = 'both', direction = 'in', top = False, right = False, length = 5, width = 1.5, labelsize = 20)
    ax.ticklabel_format(axis = 'y', style = 'sci', scilimits = (0, 0), useMathText=True)
    ax.set_xlim((np.min(Bs[cutoff:]), np.max(Bs[cutoff:])))
    ax.yaxis.get_offset_text().set_size(20)
...
def plot_MRK(Ts, Bs, MRs, rho_xx0s, cutoff, resu_dir):
    ...
    ax.set_xlabel(r'$B/\rho_{0}$ [T$\Omega^{-1}$cm$^{-1}$]', fontsize = 20)
    ax.set_ylabel(r'MR [%]', fontsize = 20)
    ax.tick_params(which = 'both', direction = 'in', top = False, right = False, length = 5, width = 1.5, labelsize = 20)
    ax.ticklabel_format(axis = 'y', style = 'sci', scilimits = (0, 0), useMathText=True)
    ax.yaxis.get_offset_text().set_size(20)
...
def plot_MREK(Ts, Bs, MRs, rho_xx0s, cutoff, resu_dir, params_file = None):
    ...
    ax.set_xlabel(r'$B/\rho_{0}n_T$ [T$\Omega^{-1}$cm$^{-1}$]', fontsize = 20)
    ax.set_ylabel(r'$MR$ [%]', fontsize = 20)
    ax.tick_params(which = 'both', direction = 'in', top = False, right = False, length = 5, width = 1.5, labelsize = 20)
    ax.ticklabel_format(axis = 'y', style = 'sci', scilimits = (0, 0), useMathText=True)
    ax.yaxis.get_offset_text().set_size(20)
    ...
    plt.plot(Ts, nTs, '-o', color = '#E33119', linewidth = 3,  markersize=14, label = 'Extended Kohler')
    ...
    if params_file:
        ...
        f, ax = plt.subplots(1, 1, figsize = (8,7))
        ax.plot(ts, nts*1E-6, '-o', color = '#2F349A', linewidth = 3,  markersize=14, label = 'Two Band')
        ax.set_xlabel(r'$T$ [K]', fontsize = 20)
        ax.set_ylabel(r'$n_T$ [Ccm$^{-3}$]', fontsize = 20)
        ax.tick_params(which = 'both', direction = 'in', top = False, right = False, length = 5, width = 1.5, labelsize = 20)
        ax.yaxis.get_offset_text().set_size(20)
        plt.legend(fontsize = 20)
        ...
        f, axs = plt.subplots(1, 1, figsize = (8,7))
        plt.plot(Ts, nTs, '-o', color = '#E33119', linewidth = 3,  markersize=14, label = 'Extended Kohler')
        plt.plot(ts, nts/nts[-1], '-o', color = '#2F349A', linewidth = 3,  markersize=14, label = 'Two Band')
        axs.set_xlabel(r'$T$ [K]', fontsize = 20)
        axs.set_ylabel(r'$n_T$ [normalized at 300K]', fontsize = 20)
        axs.tick_params(which = 'both', direction = 'in', top = False, right = False, length = 5, width = 1.5, labelsize = 20)
        axs.yaxis.get_offset_text().set_size(20)
